...
<body onload="window.print()">
    ...
    <h3>REKAPITULASI KEHADIRAN PENGURUS</h3>
    ...
    <table class="table-rekap">
        <thead>
            <tr>
                ...
                <th rowspan="2" class="text-left" width="200">Nama Pengurus</th>
                <th rowspan="2" class="text-left" width="100">Jabatan</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left"><?= $u['jabatan'] ?></td>
                ...
                <?php 
                    ...
                    for($d=1; $d<=$jumlah_hari; $d++):
                        ...
                        if($statusRaw) {
                            $tampil = substr($statusRaw, 0, 1); // Ambil huruf depan
