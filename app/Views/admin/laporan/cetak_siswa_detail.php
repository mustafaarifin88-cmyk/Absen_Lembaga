...
<head>
    ...
    <title>Laporan Detail Absensi Siswa</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="report-title">
            <h3>LAPORAN DETAIL ABSENSI SISWA</h3>
            <p>
                Kelas: <?= $info_kelas ? $info_kelas : 'Semua Kelas' ?> <br>
                ...
                <?php if (empty($absensi)) : ?>
                    <tr>
                        <td colspan="7" style="text-align:center; padding: 20px; font-style:italic; color:#999;">
                            Tidak ada data absensi siswa pada periode ini.
                        </td>
                    </tr>
                <?php else : ?>
                    <?php 
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-muted-small">NISN: <?= esc($row['nomor_induk']) ?></span>
                                <span class="text-muted-small"><?= esc($row['nama_kelas']) ?></span>
                            </td>
